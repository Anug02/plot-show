...
st.header('Data Visualisation with Matplotlib & Seaborn')
...
with col1:
    fig1 =plt.figure()
    sns.set_style('darkgrid')     #add the parameters separately.
...
with col2:
    ...
    fig2 =plt.figure(figsize=(5,5))
    sns.set_theme(context ='poster',style ='darkgrid') #add the multiple parameters adjointly.
    sns.distplot(df['PetalLengthCm'],hist =False)
    st.pyplot(fig2)

st.header('5.Exploring the different Graph.')
